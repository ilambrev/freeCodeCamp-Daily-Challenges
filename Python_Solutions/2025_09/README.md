...
# 2025.09.26 Challenge - Caught Speeding

My solution -> *[2025_09_26_caught_speeding](2025_09_26_caught_speeding.py)*
...
```
Input: speeding([50, 60, 55], 60) => Output: [0, 0]

Input: speeding([58, 50, 60, 55], 55) => Output: [2, 4]

Input: speeding([61, 81, 74, 88, 65, 71, 68], 70) => Output: [4, 8.5]

Input: speeding([100, 105, 95, 102], 100) => Output: [2, 3.5]

Input: speeding([40, 45, 44, 50, 112, 39], 55) => Output: [1, 57]
```
