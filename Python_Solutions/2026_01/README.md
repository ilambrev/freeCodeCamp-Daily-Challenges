...
# 2026.01.30 Challenge - Letters-Numbers

My solution -> *[2026_01_30_valid_pawn_moves](2026_01_30_valid_pawn_moves.py)*
...
```
Input: find_pawn_moves("D4") => Output: ["D5"]

Input: find_pawn_moves("B2") => Output: ["B3", "B4"]

Input: find_pawn_moves("A7") => Output: ["A8"]

Input: find_pawn_moves("G2") => Output: ["G3", "G4"]

Input: find_pawn_moves("E3") => Output: ["E4"]
```
