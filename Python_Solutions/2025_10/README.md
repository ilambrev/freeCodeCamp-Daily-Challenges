...
# 2025.10.29 Challenge - Email Sorter

My solution -> *[2025_10_29_email_sorter](2025_10_29_email_sorter.py)*
...
```
Input: sort(["jill@mail.com", "john@example.com", "jane@example.com"]) => Output: ["jane@example.com", "john@example.com", "jill@mail.com"]

Input: sort(["bob@mail.com", "alice@zoo.com", "carol@mail.com"]) => Output: ["bob@mail.com", "carol@mail.com", "alice@zoo.com"]

Input: sort(["user@z.com", "user@y.com", "user@x.com"]) => Output: ["user@x.com", "user@y.com", "user@z.com"]

Input: sort(["sam@MAIL.com", "amy@mail.COM", "bob@Mail.com"]) => Output: ["amy@mail.COM", "bob@Mail.com", "sam@MAIL.com"]

Input: sort(["simon@beta.com", "sammy@alpha.com", "Sarah@Alpha.com", "SAM@ALPHA.com", "Simone@Beta.com", "sara@alpha.com"]) => Output: ["SAM@ALPHA.com", "sammy@alpha.com", "sara@alpha.com", "Sarah@Alpha.com", "simon@beta.com", "Simone@Beta.com"]
```
