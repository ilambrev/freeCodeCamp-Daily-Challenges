...
# 2026.07.24 Challenge - Loan Calculator

My solution -> *[2026_07_24_loan_calculator](2026_07_24_loan_calculator.py)*
...
```
Input: get_loan_schedule(1000, 0, 200) => Output: [1000, 800, 600, 400, 200, 0]

Input: get_loan_schedule(1000, 5, 200) => Output: [1000, 804, 608, 410, 212, 13, 0]

Input: get_loan_schedule(10, 50, 1) => Output: [10, 9, 9, 8, 8, 7, 6, 5, 5, 4, 3, 2, 1, 0, 0]

Input: get_loan_schedule(5500, 8, 400) => Output: [5500, 5137, 4771, 4403, 4032, 3659, 3283, 2905, 2525, 2141, 1756, 1367, 977, 583, 187, 0]

Input: get_loan_schedule(50000, 5.2, 1650) => Output: [50000, 48567, 47127, 45681, 44229, 42771, 41306, 39835, 38358, 36874, 35384, 33887, 32384, 30874, 29358, 27835, 26306, 24770, 23227, 21678, 20122, 18559, 16990, 15413, 13830, 12240, 10643, 9039, 7428, 5810, 4186, 2554, 915, 0]
```
#
...
# 2026.07.30 Challenge - Contrast Rating 3

My solution -> *[2026_07_30_contrast_rating_3](2026_07_30_contrast_rating_3.py)*
...
```
Input: get_contrast_rating([255, 255, 255], [0, 0, 0], False) => Output: "AAA"

Input: get_contrast_rating([215, 188, 188], [55, 55, 55], False) => Output: "AA"

Input: get_contrast_rating([143, 144, 210], [46, 47, 61], False) => Output: "Fail"

Input: get_contrast_rating([167, 167, 210], [53, 10, 53], True) => Output: "AAA"

Input: get_contrast_rating([135, 147, 155], [60, 70, 90], True) => Output: "AA"

Input: get_contrast_rating([125, 210, 195], [105, 130, 90], True) => Output: "Fail"
```
#
